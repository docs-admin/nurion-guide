...
![](<../../assets/Burst buffer IME performs the role of a cache in the Nurion.png>)
...
![](<../../assets/버스트버퍼(Burst Buffer) 사용법(1).png>)
...
![](<../../assets/When the overall available space is 15% or below.png>)
