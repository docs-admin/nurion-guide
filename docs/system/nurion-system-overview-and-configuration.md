...
![\[누리온 구성도\]](../../assets/46cGZjtaR1zSlum.png)

![\[누리온 시스템 사양 및 구성\]](../../assets/nurion-specification-configuration.png)
...
![\[KNL 기반 계산노드 블록 다이어그램\]](../../assets/pOeRBFHIcyQUwfC.png)

![\[KNL 기반 계산노드\]](../../assets/MteLQQNt86MTMEz.png)
...
![\[SKL 기반 CPU-only 노드 블록 다이어그램\]](../../assets/NwiAvTQB3n1mbjQ.png)

![\[SKL 기반 CPU-only 노드\]](../../assets/h3jV5a33UZiVL0I.png)
...
![\[인터커넥트 네트워크 구성도\]](../../assets/89LSApl4oE0nAN0.png)
...
![\[병렬파일시스템 및 버스트버퍼 전체 랙 구성\]](../../assets/sOdKlUWMwnbB9lP.png)

![\[PFS 서버 구성\]](../../assets/UikUtB7HWx9PSti.png)
...
![\[Burst Buffer 역할\]](../../assets/6n7FDTWgDLwFPaD.png) ![\[Burst Buffer 서버 구성\]](../../assets/ijCBgRkhSskY4Fv.png)
